                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-4 sm:px-5 rounded-xl flex items-center justify-center gap-2 shadow-md shadow-emerald-600/30 transition-all hover:scale-[1.02]"
                                        >
                                            <Search size={18} />
